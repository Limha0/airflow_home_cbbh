...
from util.only1.saeol_util_only1 import SaeolUtil
...
@dag(
    dag_id="sdag_api_to_csv_saeol_only1_2020",
    schedule="0 1 * * *",
...
def api_to_csv_saeol():
    ...
    def insert_collect_data_info(**kwargs):
        ...
        select_bsc_info_stmt = '''
                            ...
                            WHERE 1=1
                                ...
                                AND LOWER(dtst_cd) IN ('data677') -- 새올_민원통계
                            ORDER BY sn
                            '''
    ...
    def call_url_process(collect_data_list):
        ...
        def call_url(collect_data_list, file_path, **kwargs):
            ...
            #-------------------- 초기구축 --------------------
            params_dict = {}
            start_date = datetime(year=2020,month=1,day=1,tz="Asia/Seoul")
            end_date = datetime(year=2021,month=1,day=1,tz="Asia/Seoul")
            date_list = DateUtil.get_date_list(start_date, end_date)
            ...
            try:
                ...
                while repeat_num <= params_len:
                    ...
                    while page_no <= total_page:
                        ...
                        file_name = tn_data_bsc_info.dtst_nm + "_" + file_year + "." + tn_clct_file_info.insd_file_extn  # csv 파일명
                        source_file_name = tn_data_bsc_info.dtst_nm + "_" + file_year + "." + tn_data_bsc_info.pvdr_sou_data_pvsn_stle  # 원천 파일명
                        full_file_name = full_file_path + file_name
                        #-------------------------------------------------
                        ...
                        if res_code == "Y":
                            ...
                            result = CallUrlUtil.read_json(json_data, pvdr_site_cd, tn_data_bsc_info.pvdr_inst_cd, dtst_cd, tn_data_bsc_info.data_se_col_one)
