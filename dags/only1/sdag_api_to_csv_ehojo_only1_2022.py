...
@dag(
    dag_id="sdag_api_to_csv_ehojo_only1_2022",
    schedule="@daily",
...
def sdag_api_to_csv_ehojo_only1():
    ...
    def insert_collect_data_info(**kwargs):
        ...
        data_interval_start = datetime(2022, 1, 1, tz="Asia/Seoul")  # 2022년으로 고정
        # data_interval_end = kwargs['data_interval_end'].in_timezone("Asia/Seoul")  # 실제 실행하는 날짜를 KST 로 설정
        data_interval_end = datetime(2022, 12, 31, tz="Asia/Seoul")  # 2022년으로 고정
        collect_data_list = []
        try:
