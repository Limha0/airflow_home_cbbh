...
def csv_to_dw_hadoop():
        ...
        try:
            ...
            for line in lines:
                if "namenode01.gbgs.go.kr:8020" in line and "active" in line:
                    active_namenode = "hdfs://192.168.1.23:8020"
                elif "namenode02.gbgs.go.kr:8020" in line and "active" in line:
                    active_namenode = "hdfs://192.168.1.24:8020"
    ...
    ext_data_list >> unzip_decrypt_file(ext_data_list) >> check_file_in_final_path() >> get_active_namenode() >> move_file_to_hadoop(active_namenode) >> loading_data_lists >> create_temp_file_in_db(loading_data_lists) >> lists_column_info >> dw_loading(lists_column_info)
