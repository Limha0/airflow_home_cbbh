...
@dag(
    dag_id="sdag_api_to_csv_saeol_only1_2023",
    schedule="0 1 * * *",
...
def api_to_csv_saeol():
    ...
    def call_url_process(collect_data_list):
        ...
        def call_url(collect_data_list, file_path, **kwargs):
            ...
            #-------------------- 초기구축 --------------------
            params_dict = {}
            start_date = datetime(year=2023,month=1,day=1,tz="Asia/Seoul")
            end_date = datetime(year=2024,month=1,day=1,tz="Asia/Seoul")
