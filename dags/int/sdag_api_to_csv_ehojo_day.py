                    ...
                    while page_index <= total_page:
                        ...
                        if retry_num >= 5:
                            ...
                            if params_len == 1:
                                ...
                                CallUrlUtil.insert_fail_history_log(th_data_clct_mastr_log, base_url, file_path, session, params_dict['param_list'][repeat_num - 1], page_index)
                        ...
                        data = EhojoUtil.set_url(dtst_cd, params_dict, repeat_num, page_index, interface_id, encrypt_key_ehojo, th_data_clct_mastr_log.data_crtr_pnttm)
                        ...
                        # url 호출 시 메세지 설정
                        header, mode = CallUrlUtil.get_request_message(retry_num, repeat_num, page_index, base_url, total_page, full_file_name, header, mode)
...
if __name__ == "__main__":
    ...
    dag_object.test(
        execution_date=datetime(2024,8,2,15,00),
